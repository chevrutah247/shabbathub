...
export default function AddPdfPage() {
  ...
  const uk: Record<string, string> = {
    'Этот PDF URL уже есть в библиотеке: ': 'Цей PDF URL уже є в бібліотеці: ',
    ...
    'Выберите PDF файл': 'Виберіть PDF файл',
    'Укажите ссылку на PDF': 'Вкажіть посилання на PDF',
    'Найдены похожие материалы. Выберите: ДУБЛИКАТ или НЕ ДУБЛИКАТ.': 'Знайдено схожі матеріали. Виберіть: ДУБЛІКАТ або НЕ ДУБЛІКАТ.',
    'Материал помечен как дубликат и не был опубликован.': 'Матеріал позначено як дублікат і не опубліковано.',
    'Необходимо войти в систему': 'Необхідно увійти в систему',
    'Этот PDF уже добавлен: ': 'Цей PDF уже додано: ',
    'Дубликат: в этой публикации уже есть выпуск с номером ': 'Дублікат: у цій публікації вже є випуск з номером ',
    'Этот PDF уже добавлен в библиотеку.': 'Цей PDF уже додано в бібліотеку.',
    'В этой публикации уже существует выпуск с таким номером.': 'У цій публікації вже існує випуск з таким номером.',
    'Ошибка сохранения': 'Помилка збереження',
    'Материал добавлен!': 'Матеріал додано!',
    'Перенаправление в каталог...': 'Перенаправлення в каталог...',
    'Вернуться в каталог': 'Повернутися до каталогу',
    'Карточка нового материала · ShabbatHub Library': 'Картка нового матеріалу · ShabbatHub Library',
    'Добавить материал': 'Додати матеріал',
    'Жесткий дубликат': 'Жорсткий дублікат',
    'Проверка на дубликат': 'Перевірка на дублікат',
    'Сравни новый файл с найденными похожими и выбери решение.': 'Порівняй новий файл зі схожими та вибери рішення.',
    'Проверить в админке': 'Перевірити в адмінці',
    'Новый файл': 'Новий файл',
    'Без названия': 'Без назви',
    'Открыть файл': 'Відкрити файл',
    'Материал помечен как дубликат. Новый файл не будет опубликован.': 'Матеріал позначено як дублікат. Новий файл не буде опубліковано.',
    'ДУБЛИКАТ': 'ДУБЛІКАТ',
    'НЕ ДУБЛИКАТ': 'НЕ ДУБЛІКАТ',
    'Название *': 'Назва *',
    'Например: Шомрей Шабос №805 Мишпатим': 'Наприклад: Шомрей Шабос №805 Мішпатім',
    'Публикация (издание)': 'Публікація (видання)',
    'Начните вводить название...': 'Почніть вводити назву...',
    'Не найдено': 'Не знайдено',
    '+ Создать новую публикацию': '+ Створити нову публікацію',
    'Номер выпуска (опц.)': 'Номер випуску (опц.)',
    'Дата выхода': 'Дата виходу',
    'Еврейская дата': 'Єврейська дата',
    'Авто': 'Авто',
    'Недельная глава': 'Тижнева глава',
    '— Не указана —': '— Не вказано —',
    'Событие / Праздник (опц.)': 'Подія / Свято (опц.)',
    '— Не указано —': '— Не вказано —',
    'Язык материала': 'Мова матеріалу',
    'Русский': 'Російська',
    'עברית (Иврит)': 'עברית (Іврит)',
    'PDF файл *': 'PDF файл *',
    'Загрузить файл': 'Завантажити файл',
    'Вставить ссылку': 'Вставити посилання',
    'Отпустите файл': 'Відпустіть файл',
    'Перетащите PDF сюда': 'Перетягніть PDF сюди',
    'или ': 'або ',
    ...
    'Превью (обложка)': 'Прев’ю (обкладинка)',
    'Авто из Google Drive': 'Авто з Google Drive',
    'https://... (URL картинки)': 'https://... (URL зображення)',
    'Описание (опционально)': 'Опис (опціонально)',
    'Краткое описание содержимого...': 'Короткий опис вмісту...',
    'Загрузка файла...': 'Завантаження файлу...',
    'Сохранение...': 'Збереження...',
    'Проверка...': 'Перевірка...',
    'Добавить в библиотеку': 'Додати до бібліотеки',
    'ShabbatHub Digital Library · Формуляр загрузки': 'ShabbatHub Digital Library · Форма завантаження',
  };
  const he: Record<string, string> = {
    'Этот PDF URL уже есть в библиотеке: ': 'כתובת PDF זו כבר קיימת בספרייה: ',
    ...
    'Выберите PDF файл': 'בחר קובץ PDF',
    'Укажите ссылку на PDF': 'הזן קישור ל-PDF',
    'Найдены похожие материалы. Выберите: ДУБЛИКАТ или НЕ ДУБЛИКАТ.': 'נמצאו פריטים דומים. בחר: כפול או לא כפול.',
    'Материал помечен как дубликат и не был опубликован.': 'הפריט סומן ככפול ולא פורסם.',
    'Необходимо войти в систему': 'יש להתחבר למערכת',
    'Этот PDF уже добавлен: ': 'PDF זה כבר נוסף: ',
    'Дубликат: в этой публикации уже есть выпуск с номером ': 'כפול: בפרסום זה כבר קיים גיליון מספר ',
    'Этот PDF уже добавлен в библиотеку.': 'PDF זה כבר נוסף לספרייה.',
    'В этой публикации уже существует выпуск с таким номером.': 'בפרסום זה כבר קיים גיליון עם מספר זה.',
    'Ошибка сохранения': 'שגיאת שמירה',
    'Материал добавлен!': 'הפריט נוסף!',
    'Перенаправление в каталог...': 'מעביר לקטלוג...',
    'Вернуться в каталог': 'חזרה לקטלוג',
    'Карточка нового материала · ShabbatHub Library': 'כרטיס פריט חדש · ShabbatHub Library',
    'Добавить материал': 'הוסף פריט',
    'Жесткий дубликат': 'כפילות קשיחה',
    'Проверка на дубликат': 'בדיקת כפילות',
    'Сравни новый файл с найденными похожими и выбери решение.': 'השווה את הקובץ החדש לפריטים דומים ובחר החלטה.',
    'Проверить в админке': 'בדיקה בממשק ניהול',
    'Новый файл': 'קובץ חדש',
    'Без названия': 'ללא שם',
    'Открыть файл': 'פתח קובץ',
    'Материал помечен как дубликат. Новый файл не будет опубликован.': 'הפריט סומן ככפול. הקובץ החדש לא יפורסם.',
    'ДУБЛИКАТ': 'כפול',
    'НЕ ДУБЛИКАТ': 'לא כפול',
    'Название *': 'כותרת *',
    'Например: Шомрей Шабос №805 Мишпатим': 'לדוגמה: Shomrei Shabbos #805 Mishpatim',
    'Публикация (издание)': 'פרסום',
    'Начните вводить название...': 'התחל להקליד כותרת...',
    'Не найдено': 'לא נמצא',
    '+ Создать новую публикацию': '+ צור פרסום חדש',
    'Номер выпуска (опц.)': 'מספר גיליון (אופציונלי)',
    'Дата выхода': 'תאריך פרסום',
    'Еврейская дата': 'תאריך עברי',
    'Авто': 'אוטומטי',
    'Недельная глава': 'פרשת השבוע',
    '— Не указана —': '— לא צוין —',
    'Событие / Праздник (опц.)': 'אירוע / חג (אופציונלי)',
    '— Не указано —': '— לא צוין —',
    'Язык материала': 'שפת החומר',
    'Русский': 'רוסית',
    'עברית (Иврит)': 'עברית',
    'PDF файл *': 'קובץ PDF *',
    'Загрузить файл': 'העלה קובץ',
    'Вставить ссылку': 'הדבק קישור',
    'Отпустите файл': 'שחרר את הקובץ',
    'Перетащите PDF сюда': 'גרור PDF לכאן',
    'или ': 'או ',
    ...
    'Превью (обложка)': 'תצוגה מקדימה (כריכה)',
    'Авто из Google Drive': 'אוטומטי מ-Google Drive',
    'https://... (URL картинки)': 'https://... (URL של תמונה)',
    'Описание (опционально)': 'תיאור (אופציונלי)',
    'Краткое описание содержимого...': 'תיאור קצר של התוכן...',
    'Загрузка файла...': 'מעלה קובץ...',
    'Сохранение...': 'שומר...',
    'Проверка...': 'בודק...',
    'Добавить в библиотеку': 'הוסף לספרייה',
    'ShabbatHub Digital Library · Формуляр загрузки': 'ShabbatHub Digital Library · טופס העלאה',
  };
